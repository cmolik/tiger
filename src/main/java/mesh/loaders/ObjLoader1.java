            ...
            while ((line = br.readLine()) != null) {
                ...
                //System.out.println("Comment line.");
                    ...
                    try {
                        ...
                        if (mtllib != null) {
                            appearances.putAll(MtlLoader.loadFile(file.getParent() + "/" + mtllib));
                        }
                    ...
                    if (meshGeometry.numberOfVertices() > 0) {
