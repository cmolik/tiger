...
public class Example3 {
    public static void main(String[] args) {
        ...
        Mesh stomachMesh = scene.getMesh("udder_None_(null)");
        stomachMesh.setRenderer(new PointMeshRenderer());
        Mesh raspMesh = scene.getMesh("hide_None_(null)");
        raspMesh.setRenderer(new EdgeMeshRenderer());
